...
<button type="button" data-toggle="modal"  data-bs-toggle="modal"  data-bs-target="#TambahModal" class="btn btn-sm btn-outline-secondary">
...
<div class="container-fluid">
  ...
  <tbody>
    ...
    <tr>
      ...
      <td><?=$d['namadivisi']?></td>
      <td>
      <a href="#detailModal<?= $d['id']; ?>" data-toggle="modal"  data-bs-toggle="modal"><span class="badge bg-info ">Detail</span></a>
      <a href="#editlModal<?= $d['id'] ; ?>" data-toggle="modal"  data-bs-toggle="modal"><span class="badge bg-warning ">Edit</span></a>
...
<div class="modal fade" id="TambahModal" tabindex="-1" aria-labelledby="TambahModalLabel" aria-hidden="true">
  ...
  <input type="text" class="form-control <?=($validation->hasError('namaDivisi')) ? 'is-invalid' : ''  ;?> " aria-label="Sizing example input" aria-describedby="inputGroup-sizing-default"  name="namaDivisi" >
...
<div class="modal fade" id="detailModal<?= $d['id']; ?>" tabindex="-1" aria-labelledby="detailModalLabel" aria-hidden="true">
  ...
  <input type="text" class="form-control" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-default" value="<?= $d['id']; ?>" disabled >
      </div>
  ...
  <input type="text" class="form-control" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-default" value="<?= $d['updated_at']; ?>"  disabled  >
      </div>

      <div class="input-group mb-3">
  <span class="input-group-text" id="inputGroup-sizing-default">Update By</span>
  <input type="text" class="form-control" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-default" value="<?= $d['updated_by']; ?>"  disabled >
      </div>
...
<?php $i = 1; ?>
<?php foreach ($divisi as $d ) : ?>
<div class="modal fade" id="editlModal<?= $d['id']; ?>" tabindex="-1" aria-labelledby="editlModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
  ...
  <input type="text" class="form-control" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-default" value="<?= $d['id']; ?>" disabled>
      ...
      <div class="input-group mb-3">
  <span class="input-group-text" id="inputGroup-sizing-default">Nama Divisi</span>
  <input type="text" class="form-control" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-default" value="<?= $d['namadivisi']; ?>" name='namaDivisi' >
      </div>
